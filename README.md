...
* Used conditional formatting to fill each cell in the `Percent Funded` column using a three-color scale. The scale was started at 0 and be a dark shade of red, transitioning to green at 100, and blue at 200.
  ...
  * Created a stacked column pivot chart that can be filtered by country based on the table had created.
...
* The dates stored within the `deadline` and `launched_at` columns use Unix timestamps. These timestamps were converted to a normal date. 
...
* The number of supporters of successful and unsuccessful campaigns was evaluated.

* A worksheet has been created, each with a column for supporters of successful campaigns and unsuccessful campaigns.

  ![Images/backers01.png](Images/backers01.png)

* The following have been evaluated for successful campaigns and then unsuccessful campaigns.
